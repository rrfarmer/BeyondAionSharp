...
/// <summary>
/// Java parity: network/aion/serverpackets/SM_SYSTEM_MESSAGE (-Nemesiss-, EvilSpirit, Luno, Avol, Simple, Sarynth).
/// System message packet with the full generated catalog of STR_* factory methods (1:1 with the Java file).
/// GENERATED by scripts/parity/gen_sm_system_message.py - do not edit by hand. Parallel to the reworked
/// SM_SYSTEM_MESSAGE : AionServerPacket (no collision). AionServerPacket base + WriteC/WriteD/WriteS are the
/// deferred NIO layer (red-tolerated). Object... -> params object[]; String->string, byte->sbyte, etc.
/// </summary>
public sealed class SM_SYSTEM_MESSAGE : AionServerPacket
{
    ...
    /* %num0:%num1:%num2 */
    public static SM_SYSTEM_MESSAGE STR_HOUR_MIN_SEC(sbyte num0, sbyte num1, sbyte num2)
    {
        return new SM_SYSTEM_MESSAGE(1300530, num0, num1, num2);
    }

    /* %num0:%num1 */
    public static SM_SYSTEM_MESSAGE STR_HOUR_MIN(sbyte num0, sbyte num1)
    {
        return new SM_SYSTEM_MESSAGE(1300531, num0, num1);
    }

    /* %num0:0:%num1 */
    public static SM_SYSTEM_MESSAGE STR_HOUR_0MIN_SEC(sbyte num0, sbyte num1)
    {
        return new SM_SYSTEM_MESSAGE(1300532, num0, num1);
    }

    /* %num0h */
    public static SM_SYSTEM_MESSAGE STR_HOUR(sbyte num0)
    {
        return new SM_SYSTEM_MESSAGE(1300533, num0);
    }

    /* %num0:%num1 */
    public static SM_SYSTEM_MESSAGE STR_MIN_SEC(sbyte num0, sbyte num1)
    {
        return new SM_SYSTEM_MESSAGE(1300534, num0, num1);
    }

    /* %num0m */
    public static SM_SYSTEM_MESSAGE STR_MIN(sbyte num0)
    {
        return new SM_SYSTEM_MESSAGE(1300535, num0);
    }

    /* %num0s */
    public static SM_SYSTEM_MESSAGE STR_SEC(sbyte num0)
    {
    ...
    public static SM_SYSTEM_MESSAGE STR_SUPPORT_QUOTA_REACHED(sbyte num0)
    {
    ...
    /* &lt;p&gt;A Rift Portal battle has begun.&lt;/p&gt; &lt;p&gt;If the Rift Generator is destroyed or &lt;/p&gt; &lt;p&gt;if you leave the battlefield,&lt;/p&gt; &lt;p&gt;you will automatically return to your camp and be kicked out of the alliance.&lt;/p&gt; &lt;p&gt;&lt;/p&gt; &lt;p&gt;You will also quit the alliance if you return by using a skill or an item.&lt;/p&gt; */
    ...
    /* &lt;p&gt;You have moved through the Advance Corridor.&lt;/p&gt; &lt;p&gt;If the Advance Corridor Generator is destroyed,&lt;/p&gt; &lt;p&gt;you will be returned to your previous location.&lt;/p&gt; */
    ...
    /* The Advance Corridor Shield has been activated. If the protection device is destroyed, the corridor will disappear and you will return to the fortress. */
    ...
    /* One Fortress Soul Anchor has been destroyed. If one more Fortress Soul Anchor is destroyed, then you can no longer resurrect inside the fortress. */
    public static SM_SYSTEM_MESSAGE STR_MSG_GAB1_REBIRTHMA_DE_01()
    {
        return new SM_SYSTEM_MESSAGE(1402643);
    }

    /* All of the Fortress Soul Anchors have been destroyed. Players defending the fortress will return to where they entered Panesterra when resurrected. */
    public static SM_SYSTEM_MESSAGE STR_MSG_GAB1_REBIRTHMA_DE_02()
    {
        return new SM_SYSTEM_MESSAGE(1402644);
    }

    /* The Northwest Quarter Soul Anchor has been destroyed. Those players bound to the destroyed Sanctum Soul Anchor will return to the place where they came from when resurrected. */
    public static SM_SYSTEM_MESSAGE STR_MSG_GAB1_REBIRTHMA_ATT_01()
    {
        return new SM_SYSTEM_MESSAGE(1402645);
    }

    /* The Northeast Quarter Soul Anchor has been destroyed. Those players bound to the destroyed Sanctum Soul Anchor will return to the place where they came from when resurrected. */
    public static SM_SYSTEM_MESSAGE STR_MSG_GAB1_REBIRTHMA_ATT_02()
    {
        return new SM_SYSTEM_MESSAGE(1402646);
    }

    /* The Southeast Quarter Soul Anchor has been destroyed. Those players bound to the destroyed Sanctum Soul Anchor will return to the place where they came from when resurrected. */
    public static SM_SYSTEM_MESSAGE STR_MSG_GAB1_REBIRTHMA_ATT_03()
    {
        return new SM_SYSTEM_MESSAGE(1402647);
    }

    /* The Southwest Quarter Soul Anchor has been destroyed. Those players bound to the destroyed Sanctum Soul Anchor will return to the place where they came from when resurrected. */
    ...
    {
        return new SM_SYSTEM_MESSAGE(1400023, victim.GetRace().GetL10n(), AbyssRankEnumExtensions.GetRankL10n(victim), victim.GetName(), zoneName);
    }
    ...
    public SM_SYSTEM_MESSAGE(int msgId, params object[] @params)
        : this(ChatType.GOLDEN_YELLOW, null, msgId, @params, new string[0])
    {
    }

    public SM_SYSTEM_MESSAGE(ChatType chatType, VisibleObject sender, int msgId, params object[] @params)
        : this(chatType, sender, msgId, @params, new string[0])
    {
    }

    public SM_SYSTEM_MESSAGE(ChatType chatType, VisibleObject sender, int msgId, object[] @params, params string[] specialParams)
    {
    ...
    protected override void WriteImpl(AionConnection con)
    {
        ...
        foreach (string param in specialParams)
        {
            WriteS(param);
        }
    }
