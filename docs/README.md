...
Start with `csharp-port.md`, `HANDOFF.md`, and `Full-Parity-Backlog.md` for conversion state. Use `upstream-porting.md` and `upstream-port-log.md` for subsequent Java updates.
