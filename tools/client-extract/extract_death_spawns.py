...
#: Only `aggressive`, plus the class this table feeds. `DeathSpawnAI` extends `AggressiveNpcAI`, so
#: rebinding an aggressive npc adds a death spawn and changes nothing else; rebinding a `general` npc
